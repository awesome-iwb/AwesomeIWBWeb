...
const ALL_CAPABILITIES: Capability[] = [
  ...
  { id: "notification:manage", name: "通知管理", category: "ops.content", description: "新建、编辑并发送站内运营通知", sort_index: 2350 },
  { id: "gallery:manage", name: "详情图管理", category: "ops.content", description: "管理全站项目详情图轮播素材与投放", sort_index: 2360 },
  ...
  { id: 'analytics:read', name: '查看数据分析', category: 'ops.analytics', description: '查看网站访问统计和用户行为分析', sort_index: 2500 },
];
