...
conn.on('ready', () => {
  conn.exec(`cd /opt/awesomeiwb/backend && source backend.env 2>/dev/null; DATABASE_URL="postgresql://awesomeiwb:cd316733db8145bc149e54cfdeb843cabb439219146f5a1f@localhost:5432/awesomeiwb" bun run src/index.ts 2>&1 | head -30`, (err, stream) => {
