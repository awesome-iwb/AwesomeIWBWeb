...
conn.on("ready", () => {
  ...
  const commands = [
    "curl -s -H 'Host: aiwb.smart-teach.cn' http://127.0.0.1:8081/api/auth/me 2>&1",
    "curl -s -H 'Host: aiwb.smart-teach.cn' http://127.0.0.1:8081/api/capabilities 2>&1 | head -c 500",
  ];
